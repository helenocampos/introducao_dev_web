 ...
 */
package com.mycompany.somatoriohidden;
 ...
 * @author HelenoCampos
 */
@WebServlet(name = "SomatorioHiddenServlet", urlPatterns = {"/somatorioHidden"})
public class SomatorioHiddenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String acessosString = request.getParameter("acessos");
            Integer acessos = 0;
            if (acessosString != null){
                acessos = Integer.parseInt(acessosString)+1;
            }
