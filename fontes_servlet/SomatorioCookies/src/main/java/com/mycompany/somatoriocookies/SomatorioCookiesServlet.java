 ...
 */
package com.mycompany.somatoriocookies;
 ...
 * @author Heleno
 */
@WebServlet(name = "SomatorioCookiesServlet", urlPatterns = {"/somatoriocookies"})
public class SomatorioCookiesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action='somatoriocookies' method='post'>");
            ...
            if (inicioString != null && fimString != null) {
                ...
                if (cookies != null) {
                    for (Cookie cookie : cookies) {
                        if (cookie.getName().equals("acessos")) {
                            acessos = Integer.valueOf(cookie.getValue());
                        }
                    }
                }

                Cookie cookie = new Cookie("acessos", Integer.valueOf(acessos + 1).toString());
                ...
                out.println("Você usou o serviço " + (acessos) + " vezes nesse browser.");
            }
